export const translations = {
  fr_fr: {
    translation: {
      ...
      confirmDeleteItem: 'Confirmer',
      deleteItemTitle: 'Supprimer un {{dimension}}',
      deleteItemMessage: 'Cet élément va être retiré du lot.',
      deleteMode: 'Méthode',
      deleteModePercentage: 'En pourcentage',
  ...
  en_gb: {
    translation: {
      ...
      confirmDeleteItem: 'Confirm',
      deleteItemTitle: 'Delete a {{dimension}}',
      deleteItemMessage: 'This element will be removed from the lot.',
      deleteMode: 'Method',
      deleteModePercentage: 'By percentage',
      deleteModeWeight: 'By weight (kg)',
      aboutToRemoveWeight: 'You will remove {{weight}} kg from the lot.',
      aboutToRemovePercentage:
        'Lot total stays the same; siblings will share the 100%.',
  ...
  es_es: {
    translation: {
      ...
      confirmDeleteItem: 'Confirmar',
      deleteItemTitle: 'Eliminar un {{dimension}}',
      deleteItemMessage: 'Este elemento será retirado del lote.',
      deleteMode: 'Método',
      deleteModePercentage: 'En porcentaje',
      deleteModeWeight: 'En peso (kg)',
      aboutToRemoveWeight: 'Va a retirar {{weight}} kg del lote.',
      aboutToRemovePercentage:
        'El peso total del lote no cambia. Los hermanos se repartirán el 100 %.',
  ...
  de_de: {
    translation: {
      ...
      confirmDeleteItem: 'Bestätigen',
      deleteItemTitle: '{{dimension}} löschen',
      deleteItemMessage: 'Dieses Element wird aus dem Los entfernt.',
      deleteMode: 'Methode',
      deleteModePercentage: 'Nach Prozentsatz',
      deleteModeWeight: 'Nach Gewicht (kg)',
      aboutToRemoveWeight: 'Sie entfernen {{weight}} kg aus dem Los.',
      aboutToRemovePercentage:
        'Das Gesamtgewicht des Los bleibt gleich; Geschwister teilen sich die 100 %.',
